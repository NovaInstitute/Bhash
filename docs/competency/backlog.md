...
| CQ-ESG-001 | Sustainability | High | How do scheduled sustainability transactions translate into AIAO impact assertions with supporting KPIs and telemetry provenance? | [Scheduled transactions](https://docs.hedera.com/hedera/core-concepts/scheduled-transactions); [Mirror metrics](https://docs.hedera.com/hedera/mirror-node/architecture/metrics); [AIAO](https://datadudes.xyz/aiao) | Alignment query and example graph validated in Phase 4; bridge modules published for ESG onboarding. | Validated |
